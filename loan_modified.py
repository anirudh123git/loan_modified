...
st.sidebar.image(r"loan_image.jpg", caption="Loan Prediction System", use_container_width=True)  # Change filename as needed
...
if st.button("Predict Loan Status"):
    prob = random_forest_model.predict_proba(input_df)[0] 
    threshold = 0.5  
